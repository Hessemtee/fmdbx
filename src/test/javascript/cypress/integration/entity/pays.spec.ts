...
describe('Pays e2e test', () => {
  ...
  describe('new Pays page', () => {
    ...
    it('should create an instance of Pays', () => {
      cy.get(`[data-cy="nom"]`).type('Plastic').should('have.value', 'Plastic');

      cy.setFieldImageAsBytesOfEntity('drapeau', 'integration-test.png', 'image/png');

      cy.get(`[data-cy="confederation"]`).type('Wooden').should('have.value', 'Wooden');

      cy.get(`[data-cy="indiceConf"]`).type('95366').should('have.value', '95366');

      cy.get(`[data-cy="rankingFifa"]`).type('47174').should('have.value', '47174');

      cy.get(`[data-cy="anneesAvantNationalite"]`).type('30225').should('have.value', '30225');

      cy.get(`[data-cy="importanceEnJeu"]`).type('53057').should('have.value', '53057');

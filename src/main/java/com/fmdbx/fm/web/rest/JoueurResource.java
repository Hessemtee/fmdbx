...
/**
 * REST controller for managing {@link com.fmdbx.fm.domain.Joueur}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Joueur> partialUpdateJoueur(
        ...
        Optional<Joueur> result = joueurRepository
            ...
            .map(existingJoueur -> {
                ...
                if (joueur.getPosition() != null) {
                    existingJoueur.setPosition(joueur.getPosition());
                }
                if (joueur.getDateNaissance() != null) {
                    existingJoueur.setDateNaissance(joueur.getDateNaissance());
                }
                if (joueur.getNombreSelections() != null) {
                    existingJoueur.setNombreSelections(joueur.getNombreSelections());
                }
                if (joueur.getNombreButsInternationaux() != null) {
                    existingJoueur.setNombreButsInternationaux(joueur.getNombreButsInternationaux());
                }
                if (joueur.getValeur() != null) {
                    existingJoueur.setValeur(joueur.getValeur());
                }
                if (joueur.getSalaire() != null) {
                    existingJoueur.setSalaire(joueur.getSalaire());
                }
                if (joueur.getCoutEstime() != null) {
                    existingJoueur.setCoutEstime(joueur.getCoutEstime());
                }

...
export class ClubComponent implements OnInit {
  ...
  constructor(protected clubService: ClubService, protected dataUtils: DataUtils, protected modalService: NgbModal) {}

  loadAll(): void {
    this.isLoading = true;

    this.clubService.query().subscribe({
      next: (res: HttpResponse<IClub[]>) => {
  ...
  trackId(_index: number, item: IClub): number {
    return item.id!;
  }
